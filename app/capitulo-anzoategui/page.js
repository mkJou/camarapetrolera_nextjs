...
export default function CapituloAnzoategui() {
  ...
  const cargarEventos = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log('Todos los eventos:', data.eventos);
        
        // Verificar qué estados existen
        const estadosUnicos = [...new Set((data.eventos || []).map(evento => evento.estado))];
        console.log('Estados únicos encontrados:', estadosUnicos);
        
        // Filtrar eventos que pertenezcan al estado "Anzoátegui" y no estén cancelados
        const eventosAnzoategui = (data.eventos || []).filter(evento => {
          const estado = evento.estado || '';
          return (estado.toLowerCase().includes('anzoátegui') || 
                  estado.toLowerCase().includes('anzoategui')) && 
                 !evento.cancelado;
        });
        console.log('Eventos filtrados para Anzoátegui:', eventosAnzoategui);
        
        // TEMPORAL: Si no hay eventos de Anzoátegui, mostrar todos los eventos para debugging
        if (eventosAnzoategui.length === 0 && (data.eventos || []).length > 0) {
          console.log('No se encontraron eventos para Anzoátegui, mostrando todos los eventos disponibles');
          setEventos(data.eventos.slice(0, 3)); // Mostrar máximo 3 eventos para prueba
        } else {
          setEventos(eventosAnzoategui);
        }
      } else {
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .hero-section {
          height: 800px;
          background-image: url('/img/anzoategui planta.jpeg');
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-title-container">
            <h3 className="hero-subtitle">CAPÍTULO ANZOATEGUI</h3>
            <h1 className="hero-title">
              El Capítulo mantiene un importante número de empresas afiliadas por su cercanía geográfica con la Faja Petrolífera del Orinoco.
            </h1>
          </div>
        </div>
      </div>
            ...
            <div className="eventos-container">
              ...
              {loading ? (
                <div className="eventos-loading">
                  Cargando eventos de Anzoátegui...
                </div>
              ) : eventos.length === 0 ? (
                <div className="eventos-no-data">
                  No hay eventos programados para Anzoátegui en este momento.
                </div>
              ) : (
      ...
      <section className="contacto-section">
        <div className="contacto-container">
          ...
          <div className="contacto-subtitle-container">
            ...
            <h3 className="contacto-subtitle">Capítulo Anzoátegui</h3>
          </div>
          ...
          <div className="contacto-details">
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p>Urb. Colinas del Neveri, Calle No. 9, Edif. Oficinas Corporativas, entre avenidas Guzmán Lander e Intercomunal.</p>
                <p>Barcelona – Edo. Anzoátegui.</p>
              </div>
            </div>
            ...
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p><a href="mailto:anzoategui@camarapetrolera.org">anzoategui@camarapetrolera.org</a></p>
              </div>
            </div>
          </div>
        </div>
