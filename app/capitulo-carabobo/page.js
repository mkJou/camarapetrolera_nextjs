...
export default function CapituloCarabobo() {
  ...
  const cargarEventos = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Filtrar eventos que pertenezcan al estado "Carabobo" y no estén cancelados
        const eventosCarabobo = (data.eventos || []).filter(evento => {
          const estado = evento.estado || '';
          return estado.toLowerCase().includes('carabobo') && !evento.cancelado;
        });
        setEventos(eventosCarabobo);
      } else {
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .hero-section {
          height: 800px;
          background-image: url('/img/carabobo.jpg');
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-title-container">
            <h3 className="hero-subtitle">CAPÍTULO CARABOBO</h3>
            <h1 className="hero-title">
              Carabobo es considerado el estado con mayor tejido industrial, y el Capítulo agrupa empresas de los sectores fabricantes y suplidores que prestan servicios a la industria petrolera.
            </h1>
          </div>
        </div>
      </div>
            ...
            <div className="eventos-container">
              ...
              {loading ? (
                <div className="eventos-loading">
                  Cargando eventos de Carabobo...
                </div>
              ) : eventos.length === 0 ? (
                <div className="eventos-no-data">
                  No hay eventos programados para Carabobo en este momento.
                </div>
              ) : (
      ...
      <section className="contacto-section">
        <div className="contacto-container">
          ...
          <div className="contacto-subtitle-container">
            ...
            <h3 className="contacto-subtitle">Capítulo Carabobo</h3>
          </div>
          ...
          <div className="contacto-details">
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p><a href="mailto:carabobo@camarapetrolera.org">carabobo@camarapetrolera.org</a></p>
              </div>
            </div>
          </div>
        </div>
