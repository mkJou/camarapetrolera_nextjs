...
export default function CapituloMonagas() {
  ...
  const cargarEventos = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Filtrar eventos que pertenezcan al estado "Monagas" y no estén cancelados
        const eventosMonagas = (data.eventos || []).filter(evento => {
          const estado = evento.estado || '';
          return estado.toLowerCase().includes('monagas') && !evento.cancelado;
        });
        setEventos(eventosMonagas);
      } else {
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .hero-section {
          height: 800px;
          background-image: url('/img/monagas.jpg');
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-title-container">
            <h3 className="hero-subtitle">CAPÍTULO MONAGAS</h3>
            ...
            <div className="eventos-container">
              ...
              {loading ? (
                <div className="eventos-loading">
                  Cargando eventos de Monagas...
                </div>
              ) : eventos.length === 0 ? (
                <div className="eventos-no-data">
                  No hay eventos programados para Monagas en este momento.
                </div>
              ) : (
      ...
      <section className="contacto-section">
        <div className="contacto-container">
          ...
          <div className="contacto-subtitle-container">
            ...
            <h3 className="contacto-subtitle">Capítulo Monagas</h3>
          </div>
          ...
          <div className="contacto-details">
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p>Av. Alirio Ugarte Pelayo, Centro Comercial Petroriente, Piso 1 Ala Norte, Oficina 54.</p>
                <p>Maturín – Edo. Monagas.</p>
              </div>
            </div>
            ...
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p><a href="mailto:monagas@camarapetrolera.org">monagas@camarapetrolera.org</a></p>
              </div>
            </div>
          </div>
        </div>
