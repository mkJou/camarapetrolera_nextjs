...
export default function CapituloZulia() {
  ...
  const cargarEventos = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Filtrar eventos que pertenezcan al estado "Zulia" y no estén cancelados
        const eventosZulia = (data.eventos || []).filter(evento => {
          const estado = evento.estado || '';
          return estado.toLowerCase().includes('zulia') && !evento.cancelado;
        });
        setEventos(eventosZulia);
      } else {
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .hero-section {
          height: 800px;
          background-image: url('/img/CapituloZulia.png');
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-title-container">
            <h3 className="hero-subtitle">CAPÍTULO ZULIA</h3>
            ...
            <div className="eventos-container">
              ...
              {loading ? (
                <div className="eventos-loading">
                  Cargando eventos de Zulia...
                </div>
              ) : eventos.length === 0 ? (
                <div className="eventos-no-data">
                  No hay eventos programados para Zulia en este momento.
                </div>
              ) : (
      ...
      <section className="contacto-section">
        <div className="contacto-container">
          ...
          <div className="contacto-subtitle-container">
            ...
            <h3 className="contacto-subtitle">Capítulo Zulia</h3>
          </div>
          ...
          <div className="contacto-details">
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p>Av. 13 entre calles 78 y 79, Centro Empresarial Torre 13, Piso11.</p>
            ...
            <div className="contacto-item">
              ...
              <div className="contacto-text">
                <p><a href="mailto:zulia@camarapetrolera.org">zulia@camarapetrolera.org</a></p>
              </div>
            </div>
          </div>
        </div>
